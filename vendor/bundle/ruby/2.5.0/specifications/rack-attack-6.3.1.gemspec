...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<bundler>.freeze, ["< 3.0", ">= 1.17"])
      ...
      s.add_development_dependency(%q<railties>.freeze, ["< 6.1", ">= 4.2"])
    else
      s.add_dependency(%q<rack>.freeze, ["< 3", ">= 1.0"])
      s.add_dependency(%q<appraisal>.freeze, ["~> 2.2"])
      s.add_dependency(%q<bundler>.freeze, ["< 3.0", ">= 1.17"])
      ...
      s.add_dependency(%q<railties>.freeze, ["< 6.1", ">= 4.2"])
    end
  else
    s.add_dependency(%q<rack>.freeze, ["< 3", ">= 1.0"])
    s.add_dependency(%q<appraisal>.freeze, ["~> 2.2"])
